...
void Ecm(cl_ulong* a, cl_ulong* c, cl_uint Bp)
{
	...
	const char * filename = "/home/tolgag/workspace/DIVGPUTEST/src/ECM.cl";
	...
	cl_mem cc = clCreateBuffer(context, CL_MEM_READ_WRITE | CL_MEM_COPY_HOST_PTR, sizeof(cl_ulong)*NUM * 2, c, &status);
