...
void Ecm(cl_ulong* a, cl_uint Bp, cl_ulong* c)
{
	cl_context          context;
	...
	const char * filename = "C:\\Users\\tolga\\Documents\\Visual Studio 2012\\Projects\\ECMGPU\\ECMGPU\\ECM.cl";
	...
	cl_mem aa = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR, sizeof(cl_ulong)*NUM, a, &status);
