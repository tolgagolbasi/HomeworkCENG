...
static ecode_t clear_cfrac_context(factoring_machine_t* const machine) {
    ...
    if (context != NULL) {
        ...
        free_mpz_array(context->all_accepted_yi);
        free_mpz_array(context->all_accepted_xi);
        free_mpz_array(context->candidate_yi);
        free_mpz_array(context->candidate_xi);
        free_mpz_array(context->partial_yi_array);
